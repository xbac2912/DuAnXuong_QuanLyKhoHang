...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String tb_phieuNhap= "CREATE TABLE tb_phieunhap (     sophieu  INTEGER PRIMARY KEY AUTOINCREMENT                      UNIQUE,     maSP             REFERENCES tb_SanPham (MaSP) ON DELETE CASCADE                                                   ON UPDATE CASCADE,     ngaynhap TEXT,     gia      INTEGER,     soLuong INTEGER )";
