...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String tb_CTPhieuxuat ="CREATE TABLE tb_CTPhieuxuat (     SoPhieu     INTEGER NOT NULL,     MaSP        TEXT    NOT NULL,     maPhieunhap INTEGER REFERENCES tb_phieunhap (sophieu),     Soluong     INTEGER CHECK (Soluong > 0)                         NOT NULL,     PRIMARY KEY (         SoPhieu,         MaSP     ),     FOREIGN KEY (         SoPhieu     )     REFERENCES tb_phieuxuat (SoPhieu),     FOREIGN KEY (         MaSP     )     REFERENCES tb_SanPham (MaSP) )";
